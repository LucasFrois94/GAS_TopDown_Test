...
#include "P_TP_GASTestCharacter.h"
...
AP_TP_GASTestCharacter::AP_TP_GASTestCharacter()
{
	...
	//Add Attribute Set
	PlayerAttributeSet = CreateDefaultSubobject<UPlayerAttributes>(TEXT("PlayerAttributeSet"));
...
void AP_TP_GASTestCharacter::Tick(float DeltaSeconds)
{
    Super::Tick(DeltaSeconds);
}

//Ability System Functions
void AP_TP_GASTestCharacter::PossessedBy(AController* NewController)
{
